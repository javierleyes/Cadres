...
namespace Test.DAOs
{
    ...
    public class PedidoDAOTestCase
    {
        ...
        public void InsertPedido_ok()
        {
            ...
            Assert.AreEqual(pedidoIngresado.Varilla.Nombre, "Varilla creada desde Pedido service Test");
        ...
        private Varilla CrearVarilla(bool estado)
        {
            return new Varilla()
            {
                Nombre = "Varilla creada desde Pedido service Test",
